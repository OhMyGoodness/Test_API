...
/**
 * Запрос на создание или обновление автомобиля.
 *
 ...
 *     @OA\Property(property="color", type="string", example="Black", description="Цвет автомобиля (латинские буквы)"),
 *     @OA\Property(property="auto_model_id", type="integer", example=1, description="Идентификатор модели автомобиля"),
 *     @OA\Property(property="auto_mark_id", type="integer", example=1, description="Идентификатор марки автомобиля")
 * )
 */
