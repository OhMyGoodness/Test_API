...
{
    /**
     * @param AutoModelServiceInterface $autoModelService Сервис для работы с моделями автомобилей.
     */
    public function __construct(private readonly AutoModelServiceInterface $autoModelService)
    {
    }
     ...
     * )
     *
     * @param AutoModelRequest $request Запрос с данными для создания модели.
     * @return JsonResponse
     * @throws ServiceException
     */
     ...
     *
     * @param int              $id      Идентификатор модели автомобиля.
     * @param AutoModelRequest $request Запрос с данными для обновления модели.
     * @return JsonResponse
     * @throws ServiceException|ResourceNotFoundException
     */
     ...
     * @param int $id Идентификатор модели автомобиля.
     * @return JsonResponse
     * @throws ResourceNotFoundException|ServiceException Если модель не найдена или к ней привязаны автомобили.
     */
