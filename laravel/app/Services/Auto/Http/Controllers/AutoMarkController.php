...
{
    /**
     * @param AutoMarkServiceInterface $autoMarkService Сервис для работы с марками автомобилей.
     */
    public function __construct(private readonly AutoMarkServiceInterface $autoMarkService)
    {
    }
     ...
     * )
     *
     * @param AutoMarkRequest $request Запрос с данными для создания марки.
     * @return JsonResponse
     * @throws ServiceException
     */
     ...
     *
     * @param int             $id      Идентификатор марки автомобиля.
     * @param AutoMarkRequest $request Запрос с данными для обновления марки.
     * @return JsonResponse
     * @throws ServiceException|ResourceNotFoundException
     */
     ...
     *     @OA\Response(response=401, description="Не авторизован"),
     *     @OA\Response(response=404, description="Марка автомобиля не найдена"),
     *     @OA\Response(response=409, description="Конфликт - невозможно удалить марку с привязанными автомобилями"),
     *     @OA\Response(response=500, description="Внутренняя ошибка сервера")
     * )
     *
     * @param int $id Идентификатор марки автомобиля.
     * @return JsonResponse
     * @throws ResourceNotFoundException|ServiceException Если марка не найдена или к ней привязаны автомобили.
     */
